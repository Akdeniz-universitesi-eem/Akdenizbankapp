...
public class BankAccountController {
    ...
    // TODO: UPDATE BANK ACCOUNT METHOD  (completed)
    @PatchMapping
    public GenericApiResponse updateBankAccount(@PathVariable String id, @RequestBody UpdateBankAccount UpdateAcc) {
        ...
        return new GenericApiResponse(200,"Success","12345678",bankAccountInDB);
    }
    @GetMapping
